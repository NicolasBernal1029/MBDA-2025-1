...
-- 1. PoblarOK: Insertar datos válidos
INSERT INTO Equipos (nombre, color, ciudad, estadioLocal, posicion, estado, presupuesto)
VALUES ('Millonarios', 'Azul', 'Bogotá', 'El Campín', 1, TRUE, 5000000);

INSERT INTO Partidos (idPartido, fecha, hora, lugar, ciudad, estadio)
VALUES (1, TO_DATE('2025-03-22', '2025-03-22'), TO_DATE('20:30', 'HH24:MI'), 'Bogotá', 'Bogotá', 'El Campín');

INSERT INTO Jugadores (documento, nombre, posicion, estado, valorMercado, nombreEquipo)
VALUES (1000183491, 'Juan Bogotá', 'MCO', TRUE, 100000000, 'Millonarios');

-- 2. PoblarNoOK: Intentar insertar datos erróneos
-- Violación de clave primaria
INSERT INTO Equipos (nombre, color, ciudad, estadioLocal, posicion, estado, presupuesto)
VALUES ('Millonarios', 'Rojo', 'Bogotá', 'El Campín', 2, FALSE, 3000000); -- Error: nombre ya existe

-- Violación de clave foránea
INSERT INTO Jugadores (documento, nombre, posicion, estado, valorMercado, nombreEquipo)
VALUES (1000377812, 'Nicolas Bernal', 'DEF', TRUE, 5000000000, 'Real Madrid'); -- Error: Equipo no existe

-- 3. XPoblar: Eliminación de datos
DELETE FROM Jugadores WHERE documento = 1000377812;
DELETE FROM Partidos WHERE idPartido = 1;
DELETE FROM Equipos WHERE nombre = 'Millonarios';


SELECT nombre 
FROM Jugadores 
WHERE documento = 1000183491;


DROP TABLE Hinchas CASCADE CONSTRAINTS;
DROP TABLE Partidos CASCADE CONSTRAINTS;
DROP TABLE PartidosJugadosPorEquipos CASCADE CONSTRAINTS;
DROP TABLE Equipos CASCADE CONSTRAINTS;
DROP TABLE Jugadores CASCADE CONSTRAINTS;
DROP TABLE Canteranos CASCADE CONSTRAINTS;
DROP TABLE Extranjetos CASCADE CONSTRAINTS;
DROP TABLE Representantes CASCADE CONSTRAINTS;
DROP TABLE CorreosPorRepresentantes CASCADE CONSTRAINTS;
...
DROP TABLE Documentaciones CASCADE CONSTRAINTS;
DROP TABLE Gerentes CASCADE CONSTRAINTS;
DROP TABLE CorreosPorGerentes CASCADE CONSTRAINTS;
DROP TABLE Financieros CASCADE CONSTRAINTS;
DROP TABLE Deportivos CASCADE CONSTRAINTS;
